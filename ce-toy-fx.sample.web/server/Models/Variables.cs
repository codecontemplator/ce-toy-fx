namespace ce_toy_fx.sample.web.Models
{
    ...
    {
        public class CreditDef : Variable<int>
        {
            private CreditDef() { }
            public override string Name => nameof(Credit);
            public static CreditDef Instance { get; } = new CreditDef();
        }
        ...
        public static CreditDef Credit => CreditDef.Instance;
