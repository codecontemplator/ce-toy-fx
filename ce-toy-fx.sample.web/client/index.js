...
var $author$project$Main$AllApplicants = {$: 'AllApplicants'};
var $author$project$Main$Limit = {$: 'Limit'};
var $author$project$Main$Raw = {$: 'Raw'};
var $author$project$Main$Rule = function (a) {
	return {$: 'Rule', a: a};
};
var $author$project$Main$TreeNode = F2(
	function (a, b) {
...
var $author$project$Main$update = F2(
	function (msg, model) {
		var mkRuleNode = function (_v11) {
			...
			return A2(
				$author$project$Main$TreeNode,
				{children: _List_Nil, header: name, id: model.nextId, isExpanded: false, isHeaderEditEnabled: false},
				$author$project$Main$Rule(
					{condition: '<condition>', name: name, projection: '<projection>', scope: $author$project$Main$AllApplicants, type_: $author$project$Main$Limit}));
		};
		var mapTree = F2(
			function (f, _v0) {
				var n = _v0.a;
				...
				return updateProcess(
					function (_v10) {
						...
						return _Utils_eq(id, n.id) ? f(
							A2($author$project$Main$TreeNode, n, pl)) : A2($author$project$Main$TreeNode, n, pl);
					});
			});
		...
		switch (msg.$) {
			...
			case 'ToggleProcessView':
				return _Utils_update(
					model,
					{
						processView: _Utils_eq(model.processView, $author$project$Main$UI) ? $author$project$Main$Raw : $author$project$Main$UI
					});
...
var $rundis$elm_bootstrap$Bootstrap$CDN$stylesheet = A3(
	...
	_List_Nil);
var $author$project$Main$AnyApplicant = {$: 'AnyApplicant'};
...
var $author$project$Main$viewProcessDetailsRaw = function (process) {
	...
	var encodeRuleList = F2(
		function (maybeName, rules) {
			var perApplicant = A2(
				$elm$core$List$any,
				function (_v0) {
					var child = _v0.b.a;
					return _Utils_eq(child.scope, $author$project$Main$AnyApplicant);
				},
				rules);
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'children',
							A2($elm$json$Json$Encode$list, encodeRule, rules))
						]),
	...
	var json = A2(
		...
		4,
		A2(encodeRuleList, $elm$core$Maybe$Nothing, process));
	return A2(
		$elm$html$Html$pre,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$Group = {$: 'Group'};
var $author$project$Main$NewHeaderValue = F2(
	function (a, b) {
		return {$: 'NewHeaderValue', a: a, b: b};
	});
var $author$project$Main$Policy = {$: 'Policy'};
		...
		var updateRuleType = function (s) {
			return A2(
				...
				function () {
					switch (s) {
						case 'Policy':
							return $author$project$Main$Policy;
						case 'Limit':
							return $author$project$Main$Limit;
						default:
							return $author$project$Main$Group;
					}
				}());
		};
									...
									[
										...
										_List_fromArray(
											[
												...
												_Utils_eq(rule.type_, $author$project$Main$Policy))
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$selected(
												_Utils_eq(rule.type_, $author$project$Main$Limit))
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$selected(
												_Utils_eq(rule.type_, $author$project$Main$Group))
											]),
										_List_fromArray(
											[
								...
								_List_fromArray(
									[
										...
										!A2(
											...
											rule.type_,
											_List_fromArray(
												[$author$project$Main$Policy, $author$project$Main$Limit])))
									]))
							]),
						_List_fromArray(
							[
							...
							[
								...
								function (b) {
									return A2(
										...
										node.id,
										b ? $author$project$Main$AllApplicants : $author$project$Main$AnyApplicant);
								}),
								...
								_List_fromArray(
									[
										...
										!A2(
											...
											rule.type_,
											_List_fromArray(
												[$author$project$Main$Policy])))
									])),
								$rundis$elm_bootstrap$Bootstrap$Form$Checkbox$checked(
								_Utils_eq(rule.scope, $author$project$Main$AllApplicants))
							]),
										...
										_List_fromArray(
											[
												...
												(!A2(
													...
													rule.type_,
													_List_fromArray(
														[$author$project$Main$Group]))) || (!node.isExpanded))
											]))
									]),
								_List_fromArray(
									[
...
var $author$project$Main$viewProcessDetails = function (model) {
	return _Utils_eq(model.processView, $author$project$Main$UI) ? $author$project$Main$viewProcessDetailsUI(model.process) : $author$project$Main$viewProcessDetailsRaw(model.process);
};
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										_Utils_eq(model.processView, $author$project$Main$UI) ? 'View Raw' : 'View UI')
									]))
							]))
					]))
			]));
...
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{
		init: {nextId: 0, process: _List_Nil, processView: $author$project$Main$UI},
