...
var $author$project$Model$initialProcess = _List_fromArray(
	[
		A2(
		$author$project$Model$TreeNode,
		{children: _List_Nil, header: 'Max Absolute Limit', id: 1, isExpanded: false, isHeaderEditEnabled: false},
		$author$project$Model$Rule(
			{condition: '', name: 'Max Absolute Limit', projection: 'Math.Min(Vars.Amount, 1000)', ruleAggregationType: $author$project$Model$All, type_: $author$project$Model$Limit})),
		A2(
		$author$project$Model$TreeNode,
		{children: _List_Nil, header: 'Max Age Policy', id: 2, isExpanded: false, isHeaderEditEnabled: false},
		$author$project$Model$Rule(
...
var $author$project$Serialize$encodeApplication = function (application) {
	var encodeKeyValue = function (_v0) {
		var key = _v0.a;
		var value = _v0.b;
	...
	var encodeApplicant = function (applicant) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'id',
					$elm$json$Json$Encode$string(applicant.id)),
					_Utils_Tuple2(
					'keyValues',
					A2($elm$json$Json$Encode$list, encodeKeyValue, applicant.keyValues))
				]));
	};
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'requestedAmount',
				$elm$json$Json$Encode$int(application.requestedAmount)),
				_Utils_Tuple2(
				'applicants',
				A2($elm$json$Json$Encode$list, encodeApplicant, application.applicants))
			]));
};
...
var $author$project$Serialize$encodeModel = function (model) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'process',
				A2($author$project$Serialize$encodeRuleList, $elm$core$Maybe$Nothing, model.process)),
				_Utils_Tuple2(
				'application',
				$author$project$Serialize$encodeApplication(model.application))
			]));
};
var $author$project$Serialize$modelToJson = function (model) {
	return A2(
		$elm$json$Json$Encode$encode,
		4,
		$author$project$Serialize$encodeModel(model));
};
var $author$project$Serialize$mkHttpRequestBody = function (model) {
	return $author$project$Serialize$modelToJson(model);
};
...
var $author$project$Main$mkHttpRequest = function (model) {
	return $elm$http$Http$post(
		{
			body: A2(
				$elm$http$Http$stringBody,
				'application/json',
				$author$project$Serialize$mkHttpRequestBody(model)),
			expect: $elm$http$Http$expectString($author$project$Main$GotHttpResponse),
			url: 'api/evaluate'
		});
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		...
		var increaseId = function (appModel) {
			return _Utils_update(
				appModel,
				{nextId: appModel.nextId + 1});
		};
		switch (msg.$) {
			case 'AddRule':
				return noCmd(
					...
					A2(
						...
						function (_v6) {
							...
							return A2(
								...
								_Utils_update(
									n,
									{isHeaderEditEnabled: !n.isHeaderEditEnabled}),
								pl);
						}));
			case 'NewHeaderValue':
				var id = msg.a;
			...
			case 'ToggleProcessView':
				return noCmd(
					_Utils_update(
						model,
						{
							processView: _Utils_eq(model.processView, $author$project$Model$UI) ? $author$project$Model$Raw : $author$project$Model$UI
						}));
			case 'RuleConditionUpdated':
				var id = msg.a;
				var newCondition = msg.b;
				return noCmd(
					A2(
						updateNodeWithId,
						id,
			...
			case 'RuleProjectionUpdated':
				var id = msg.a;
				var newProjection = msg.b;
				return noCmd(
					A2(
						updateNodeWithId,
						id,
			...
			case 'AddApplicant':
				...
				var newApplication = _Utils_update(
					oldApplication,
					{
						applicants: _Utils_ap(
							oldApplication.applicants,
							_List_fromArray(
								[
									mkApplicant(_Utils_Tuple0)
								]))
					});
				return noCmd(
					_Utils_update(
			...
			case 'RequestedAmountUpdated':
				...
				var amount = A2(
					$elm$core$Maybe$withDefault,
					0,
					$elm$core$String$toInt(amountStr));
				var newApplication = _Utils_update(
					oldApplication,
...
var $rundis$elm_bootstrap$Bootstrap$CDN$stylesheet = A3(
	...
	_List_Nil);
var $author$project$Main$RequestedAmountUpdated = function (a) {
	return {$: 'RequestedAmountUpdated', a: a};
};
var $author$project$Main$UpdateApplicantValue = F3(
	function (a, b, c) {
		return {$: 'UpdateApplicantValue', a: a, b: b, c: c};
	});
...
var $author$project$Main$viewApplicationDetails = function (application) {
	var viewKeydApplicant = function (applicant) {
		var applicantForm = A2(
				...
				function (_v0) {
					...
					return _List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$for('key-value-' + key)
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									$rundis$elm_bootstrap$Bootstrap$Form$Input$id('key-value-' + key),
									$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(
									A2($author$project$Main$UpdateApplicantValue, applicant.id, key)),
									$rundis$elm_bootstrap$Bootstrap$Form$Input$value(value)
								]))
						]);
				},
				applicant.keyValues));
		return _Utils_Tuple2(applicant.id, applicantForm);
	};
	return A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$for('application-amount')
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('Requested Amount')
													])),
												$rundis$elm_bootstrap$Bootstrap$Form$Input$text(
												_List_fromArray(
													[
														$rundis$elm_bootstrap$Bootstrap$Form$Input$id('application-amount'),
														$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput($author$project$Main$RequestedAmountUpdated),
														$rundis$elm_bootstrap$Bootstrap$Form$Input$value(
														$elm$core$String$fromInt(application.requestedAmount))
													]))
											]))
									]))
							]))
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($elm$core$List$map, viewKeydApplicant, application.applicants))
							]))
					]))
			]));
};
var $author$project$Main$AddApplicant = {$: 'AddApplicant'};
...
var $author$project$Main$viewApplicationHeader = function (application) {
	return A2(
		$rundis$elm_bootstrap$Bootstrap$Grid$container,
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick($author$project$Main$AddApplicant)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Add Applicant')
									]))
							]))
					]))
			]));
...
var $author$project$Serialize$processToJson = function (process) {
	return A2(
		$elm$json$Json$Encode$encode,
		4,
		A2($author$project$Serialize$encodeRuleList, $elm$core$Maybe$Nothing, process));
};
var $author$project$Main$viewProcessDetailsRaw = function (process) {
	var json = $author$project$Serialize$processToJson(process);
	return A2(
		$elm$html$Html$pre,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$RuleProjectionUpdated = F2(
	function (a, b) {
...
var $author$project$Main$viewProcessDetailsUI = function (process) {
	var viewKeydRule = function (_v1) {
		var node = _v1.a;
		var rule = _v1.b.a;
		var updateRuleType = function (s) {
			return A2(
				$author$project$Main$UpdateRuleType,
				node.id,
				function () {
					switch (s) {
						case 'Policy':
							return $author$project$Model$Policy;
						case 'Limit':
							return $author$project$Model$Limit;
						default:
							return $author$project$Model$Group;
					}
				}());
		};
		var viewRuleDetails = node.isExpanded ? _List_fromArray(
			[
				A2(
				$rundis$elm_bootstrap$Bootstrap$Form$form,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$for('rule-type-selector')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$rundis$elm_bootstrap$Bootstrap$Form$Select$id('rule-type-selector'),
										$rundis$elm_bootstrap$Bootstrap$Form$Select$onChange(updateRuleType)
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												...
												_Utils_eq(rule.type_, $author$project$Model$Policy))
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$selected(
												_Utils_eq(rule.type_, $author$project$Model$Limit))
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$selected(
												_Utils_eq(rule.type_, $author$project$Model$Group))
											]),
										_List_fromArray(
											[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$for('rule-condition')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$rundis$elm_bootstrap$Bootstrap$Form$Input$id('rule-condition'),
										$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(
										$author$project$Main$RuleConditionUpdated(node.id)),
										$rundis$elm_bootstrap$Bootstrap$Form$Input$value(rule.condition)
									])),
								A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$for('rule-projection')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Projection')
									])),
								$rundis$elm_bootstrap$Bootstrap$Form$Input$text(
								_List_fromArray(
									[
										$rundis$elm_bootstrap$Bootstrap$Form$Input$id('rule-projection'),
										$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(
										$author$project$Main$RuleProjectionUpdated(node.id)),
										$rundis$elm_bootstrap$Bootstrap$Form$Input$value(rule.projection)
									])),
								A2(
								$rundis$elm_bootstrap$Bootstrap$Form$help,
								_List_Nil,
						...
						_List_fromArray(
							[
								$rundis$elm_bootstrap$Bootstrap$Form$Checkbox$id('rule-scope-all-applicants'),
									...
									[
										...
										_List_fromArray(
											[
												...
												$author$project$Main$AddSubRule(node.id))
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('Add Sub Rule')
											]))
									]))
							]))
					]))
			]) : _List_Nil;
		var ruleHeader = node.isHeaderEditEnabled ? _List_fromArray(
			[
				$rundis$elm_bootstrap$Bootstrap$Form$Input$text(
				_List_fromArray(
					[
						$rundis$elm_bootstrap$Bootstrap$Form$Input$id('node-header'),
						$rundis$elm_bootstrap$Bootstrap$Form$Input$value(node.header),
						...
						_List_fromArray(
							[
								...
								$author$project$Main$ToggleEditHeader(node.id))
							])),
						$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(
						$author$project$Main$NewHeaderValue(node.id))
					]))
			]) : _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('btn'),
						$elm$html$Html$Attributes$class('btn-lnk'),
						$elm$html$Html$Events$onClick(
						$author$project$Main$ToggleTreeNode(node.id)),
						A2($elm$html$Html$Attributes$style, 'margin-top', '10px')
					]),
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A2($rundis$elm_bootstrap$Bootstrap$Grid$col, _List_Nil, viewRuleDetails)
									])),
								A2(
								$rundis$elm_bootstrap$Bootstrap$Grid$row,
								_List_fromArray(
										...
										_List_fromArray(
											[
												...
												(!A2(
													...
													rule.type_,
													_List_fromArray(
														[$author$project$Model$Group]))) || (!node.isExpanded))
											]))
									]),
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Main$viewProcessDetailsUI(node.children)
											]))
									]))
							]))
					])));
	...
	return A2(
		...
		A2($elm$core$List$map, viewKeydRule, process));
};
var $author$project$Main$viewProcessDetails = function (model) {
	return _Utils_eq(model.processView, $author$project$Model$UI) ? $author$project$Main$viewProcessDetailsUI(model.process) : $author$project$Main$viewProcessDetailsRaw(model.process);
};
var $author$project$Main$AddRule = {$: 'AddRule'};
var $author$project$Main$ToggleProcessView = {$: 'ToggleProcessView'};
var $author$project$Main$viewProcessHeader = function (model) {
	return A2(
		$rundis$elm_bootstrap$Bootstrap$Grid$container,
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('button'),
										$elm$html$Html$Attributes$class('btn btn-primary'),
										$elm$html$Html$Events$onClick($author$project$Main$AddRule)
									]),
								_List_fromArray(
									[
							...
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('button'),
										$elm$html$Html$Attributes$class('btn btn-primary'),
										$elm$html$Html$Events$onClick($author$project$Main$ToggleProcessView)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										_Utils_eq(model.processView, $author$project$Model$UI) ? 'View Raw' : 'View UI')
									]))
							]))
					]))
			]));
};
var $author$project$Main$MakeHttpRequest = {$: 'MakeHttpRequest'};
var $author$project$Main$viewRequestResponse = function (model) {
	var responseHtml = function () {
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Request / Response')
									]))
							])),
						A2($rundis$elm_bootstrap$Bootstrap$Grid$col, _List_Nil, _List_Nil),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('button'),
										$elm$html$Html$Attributes$class('btn btn-primary'),
										$elm$html$Html$Events$onClick($author$project$Main$MakeHttpRequest)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Make Request')
									]))
							]))
					])),
				A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Main$viewProcessHeader(model)
							]))
					])),
				$rundis$elm_bootstrap$Bootstrap$Grid$simpleRow(
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Main$viewApplicationHeader(model.application)
							]))
					])),
				$rundis$elm_bootstrap$Bootstrap$Grid$simpleRow(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Main$viewApplicationDetails(model.application)
							]))
					])),
				$rundis$elm_bootstrap$Bootstrap$Grid$simpleRow(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Main$viewRequestResponse(model)
							]))
					]))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: function (flags) {
			return _Utils_Tuple2($author$project$Model$initialAppModel, $elm$core$Platform$Cmd$none);
		},
